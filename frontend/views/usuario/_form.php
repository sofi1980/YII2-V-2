...
<div class="usuario-form">
    ...
    <?= $form->field($model, 'tipodocumento')->dropDownList([ 'cédula de ciudadanía' => 'cédula de ciudadanía', 'Tarjeta de Identidad' => 'Tarjeta de Identidad','cédula de extranjería' => 'cédula de extranjería','Pasaporte' => 'Pasaporte','Permiso Especial de Permanencia'=>'Permiso Especial de Permanencia' ], ['prompt' => 'Tipo Documento']) ?>
    ...
    <?= $form->field($model, 'estado')->dropDownList([ 'active' => 'Active', 'inactive' => 'Inactive', ], ['prompt' => 'Estado']) ?>
